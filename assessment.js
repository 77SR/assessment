...
assessmentButton.onclick = () => {
    ...
    const paragram = document.createElement('p');
    const result = assessment(userName);
    paragram.innerText = result;
    resultDiv.appendChild(paragram);
...
const answer = [
    ...
    '{userName}のいいところは厳しさです。{userName}の厳しさがいつも物事を成功へ導きます。',
    '{userName}のいいところは知識です。博識な{userName}を多くの人が頼りにしています。',
    '{userName}のいいところはユニークさです。{userName}だけのその特徴が皆を楽しくさせます。',
    '{userName}のいいところは用心深さです。{userName}の洞察に多くの人が助けられます。',
    '{userName}のいいところは見た目です。内側からあふれでる{userName}のセンスの良さに皆が惹かれます。',
    '{userName}のいいところは決断力です。{userName}のする決断にいつも助けられる人がいます。',
    '{userName}のいいところは思いやりです。{userName}に気にかけてもらった多くの人がいつも感謝しています。',
    ...
    '{userName}のいいところはそその全てです。ありのままの{userName}自身がいいところなのです。',
...
console.assert(
    assessment('太郎') ===
    '太郎のいいところは決断力です。太郎のする決断にいつも助けられる人がいます。',
