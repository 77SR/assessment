 ...
 */
function removeAllChirldren(element) {
...
assessmentButton.onclick = () => {
    ...
    //診断結果の表示エリア作成
    removeAllChirldren(resultDivided);
    ...
    // tweet-area
    removeAllChirldren(tweetDivided);
...
const answer = [
    '{userName}のいいところは声です。{userName}の特徴的な声は皆を惹きつけ心に残ります。',
    ...
    '{userName}のいいところは見た目です。内側からあふれる{userName}の良さに皆が気を惹かれます。',
    ...
    '{userName}のいいところは自制心です。やばいと思ったときにしっかりと衝動を抑えらる{userName}が皆から評価されています。'
...
console.assert(
    ...
    '入力が同名前なら同じ診断結果を出力する処理が正しくありません'
);
